...
namespace Error
{
	...
	ERROR_ENTRY(608, "Ошибка в арифметическом выражении"), ERROR_ENTRY(609, "Ожидалась точка с запятой"),
	ERROR_ENTRY(610, "Ошибка в параметрах функции strcmp"), ERROR_ENTRY(611, "Ошибка в функции strcmp"),
