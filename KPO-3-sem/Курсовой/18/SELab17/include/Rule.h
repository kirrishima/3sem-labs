...
namespace GRB
{
	Greibach greibach(NS('S'), TS('$'),				//стартовый символ, дно стека
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 1,         // Операторы программы
			...
			Rule::Chain(5, TS('t'), TS('i'), TS(';'), NS('N')),                   // N → ti;N
			Rule::Chain(4, TS('i'), TS('='), NS('E'), TS(';'), NS('N')),          // N → i=E;N
